...
const WordClouds = () => {
  return (
    <Parallax
      ...
      <p style={{ top: 50, left: '100%', fontSize: 23 }}>Dash</p>
      <p style={{ top: 0, left: 0, fontSize: 25 }}>Plotly</p>
      <p style={{ top: 200, left: -60, fontSize: 14 }}>SQL</p>
      <p style={{ top: '30%', left: '35%', fontSize: 18 }}>TensorFlow</p>
      <p style={{ top: 40, left: '75%', fontSize: 12 }}>Pytorch</p>
      <p style={{ top: 380, left: '85%', fontSize: 18 }}>MongoDB</p>
      <p style={{ top: 320, left: '65%', fontSize: 18 }}>Django</p>
      <p style={{ top: 350, left: 150, fontSize: 20 }}>Scikit-learn</p>
      <p style={{ top: 120, left: '22%', fontSize: 12 }}>Pandas</p>
    </Parallax>
  )
}
  ...
  <SkillsWrapper>
    <ParallaxProvider>
      ...
      <Flex className="skill__icons" justify="space-around" align="center">
        ...
        <FontAwesomeIcon icon={["fa", "database"]} size="5x" />
